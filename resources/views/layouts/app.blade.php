...
{{--                </div>--}}
    ...
    justify-content: center;
    align-self: center;"><span class="t-color-standard-80 t-icon-contactless">&nbsp;</span>&nbsp;&nbsp;<span>Travel with confidence</span> <span>during COVID-19:</span></div>
                    <div class="at-alert-banner-icon-container" style="display: flex !important;">
                        <div class="at-alert-banner-pay-direct-container at-icon-1" ><a class="custom_click_track" ><span class="t-color-standard-80 t-icon-bestrate">&nbsp;</span> <span class="t-font-weight-semibold">Best Rate Guarantee</span></a></div> &nbsp;&nbsp;&nbsp;
                        <div class="at-alert-banner-pay-direct-container at-icon-2" style="width: 200px !important;"><a class="custom_click_track"><span class="t-color-standard-80 t-icon-cancel">&nbsp;</span> <span class="t-font-weight-semibold">Flexible Cancellation</span></a></div>&nbsp;&nbsp;&nbsp;
                        <div class="at-alert-banner-pay-direct-container at-icon-3" style="width: 200px !important;"><a class="custom_click_track" ><span class="t-color-standard-80 t-icon-clean">&nbsp;</span> <span class="t-font-weight-semibold">Commitment to Clean</span></a></div>&nbsp;&nbsp;
                        <div class="at-alert-banner-pay-direct-container at-icon-4" style="width: 200px !important;"><a class="custom_click_track" ><span class="t-color-standard-80 t-icon-contactless">&nbsp;</span> <span class="t-font-weight-semibold">Contactless Services</span></a></div>
                    </div>
                </div>
            </div>
